...
class TextModel(ModelBase):
    ...
    def get_vocab_base_pre(self, tokenizer) -> str:
        ...
        if chkhsh == "1444df51289cfa8063b96f0e62b1125440111bc79a52003ea14b6eac7016fd5f":
            # ref: InternScience/Agents-A1 -- confirmed identical pre-tokenizer regex
            # to LLAMA_VOCAB_PRE_TYPE_QWEN35 (src/llama-vocab.cpp), just a different
            # vocab/hash (custom fine-tune), not a different pretokenizer.
            res = "qwen35"
