...
struct vk_device_struct {
    ...
    // Ternary (QT_MS32K4) KHR-coopmat prefill pipelines for coopmat2 devices
    vk_matmul_pipeline2 pipeline_tern_khr;
    vk_matmul_pipeline2 pipeline_tern_khr_id;
...
#define CREATE_MM2(PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT) \
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_Q2_SYM32K4], matmul_q2_sym32k4_f16, mmq_wg_denoms_k, warptile_mmq_k, vk_mat_mat_push_constants, 3)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_QT_MS32K4], matmul_qt_ms32k4_f16, mmq_wg_denoms_k, warptile_mmq_k, vk_mat_mat_push_constants, 3)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_Q1_SYM32K], matmul_q1_sym32k_f16, mmq_wg_denoms_k, warptile_mmq_k, vk_mat_mat_push_constants, 3)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_Q4_SYM16K], matmul_q4_sym16k_f16, mmq_wg_denoms_k, warptile_mmq_k, vk_mat_mat_push_constants, 3)
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q2_SYM32K4], matmul_id_subgroup_q2_sym32k4_f16, mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_QT_MS32K4], matmul_id_subgroup_qt_ms32k4_f16, mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_SYM32K], matmul_id_subgroup_q1_sym32k_f16, mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q4_SYM16K], matmul_id_subgroup_q4_sym16k_f16, mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        if (device->coopmat_acc_f16_support) {
            ...
            CREATE_MM2(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q2_SYM32K4], matmul_q2_sym32k4_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM2(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat[GGML_TYPE_QT_MS32K4], matmul_qt_ms32k4_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM2(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q1_SYM32K], matmul_q1_sym32k_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM2(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q4_SYM16K], matmul_q4_sym16k_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            ...
            CREATE_MM(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q2_SYM32K4].f32acc, matmul_q2_sym32k4_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat[GGML_TYPE_QT_MS32K4].f32acc, matmul_qt_ms32k4_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q1_SYM32K].f32acc, matmul_q1_sym32k_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            CREATE_MM(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q4_SYM16K].f32acc, matmul_q4_sym16k_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
        ...
        CREATE_MM2(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q2_SYM32K4], matmul_id_subgroup_q2_sym32k4_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
        CREATE_MM2(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_QT_MS32K4], matmul_id_subgroup_qt_ms32k4_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
        CREATE_MM2(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_SYM32K], matmul_id_subgroup_q1_sym32k_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
        CREATE_MM2(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q4_SYM16K], matmul_id_subgroup_q4_sym16k_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID, REQSUBGROUPSIZE) \
        ...
        CREATE_MM2(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q2_SYM32K4], matmul_q2_sym32k4_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        CREATE_MM2(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat[GGML_TYPE_QT_MS32K4], matmul_qt_ms32k4_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        CREATE_MM2(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q1_SYM32K], matmul_q1_sym32k_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        CREATE_MM2(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q4_SYM16K], matmul_q4_sym16k_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->integer_dot_product) {
            ...
            CREATE_MMQ(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_Q2_SYM32K4], matmul_q2_sym32k4_q8_1, mmq_wg_denoms, warptile_mmq_int_k, vk_mat_mat_push_constants, 3, , 0);
            CREATE_MMQ(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_QT_MS32K4], matmul_qt_ms32k4_q8_1, mmq_wg_denoms, warptile_mmq_int_k, vk_mat_mat_push_constants, 3, , 0);
            CREATE_MMQ(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_Q1_SYM32K], matmul_q1_sym32k_q8_1, mmq_wg_denoms, warptile_mmq_int_k, vk_mat_mat_push_constants, 3, , 0);
            CREATE_MMQ(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_Q4_SYM16K], matmul_q4_sym16k_q8_1, mmq_wg_denoms, warptile_mmq_int_k, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM2(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q2_SYM32K4], matmul_id_subgroup_q2_sym32k4_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            CREATE_MM2(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_QT_MS32K4], matmul_id_subgroup_qt_ms32k4_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            CREATE_MM2(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_SYM32K], matmul_id_subgroup_q1_sym32k_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            CREATE_MM2(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q4_SYM16K], matmul_id_subgroup_q4_sym16k_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            if (device->integer_dot_product) {
                ...
                CREATE_MMQ(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_Q2_SYM32K4], matmul_id_subgroup_q2_sym32k4_q8_1, mmq_wg_denoms, warptile_mmqid_int_k, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size_16);
                CREATE_MMQ(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_QT_MS32K4], matmul_id_subgroup_qt_ms32k4_q8_1, mmq_wg_denoms, warptile_mmqid_int_k, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size_16);
                CREATE_MMQ(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_Q1_SYM32K], matmul_id_subgroup_q1_sym32k_q8_1, mmq_wg_denoms, warptile_mmqid_int_k, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size_16);
                CREATE_MMQ(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_Q4_SYM16K], matmul_id_subgroup_q4_sym16k_q8_1, mmq_wg_denoms, warptile_mmqid_int_k, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size_16);
            ...
            CREATE_MM2(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q2_SYM32K4], matmul_id_q2_sym32k4_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM2(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_QT_MS32K4], matmul_id_qt_ms32k4_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM2(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_SYM32K], matmul_id_q1_sym32k_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM2(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q4_SYM16K], matmul_id_q4_sym16k_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            ...
            if (device->integer_dot_product) {
                ...
                CREATE_MMQ(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_Q2_SYM32K4], matmul_id_q2_sym32k4_q8_1, mmq_wg_denoms, warptile_mmqid_int_k, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
                CREATE_MMQ(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_QT_MS32K4], matmul_id_qt_ms32k4_q8_1, mmq_wg_denoms, warptile_mmqid_int_k, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
                CREATE_MMQ(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_Q1_SYM32K], matmul_id_q1_sym32k_q8_1, mmq_wg_denoms, warptile_mmqid_int_k, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
                CREATE_MMQ(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_Q4_SYM16K], matmul_id_q4_sym16k_q8_1, mmq_wg_denoms, warptile_mmqid_int_k, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#define CREATE_MMQ(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        CREATE_MM(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q2_SYM32K4].f32acc, matmul_q2_sym32k4_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        CREATE_MM(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat[GGML_TYPE_QT_MS32K4].f32acc, matmul_qt_ms32k4_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        CREATE_MM(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q1_SYM32K].f32acc, matmul_q1_sym32k_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        CREATE_MM(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q4_SYM16K].f32acc, matmul_q4_sym16k_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->integer_dot_product) {
            ...
            CREATE_MMQ(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_Q2_SYM32K4].f32acc, matmul_q2_sym32k4_q8_1, mmq_wg_denoms, warptile_mmq_int_k, vk_mat_mat_push_constants, 3, );
            CREATE_MMQ(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_QT_MS32K4].f32acc, matmul_qt_ms32k4_q8_1, mmq_wg_denoms, warptile_mmq_int_k, vk_mat_mat_push_constants, 3, );
            CREATE_MMQ(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_Q1_SYM32K].f32acc, matmul_q1_sym32k_q8_1, mmq_wg_denoms, warptile_mmq_int_k, vk_mat_mat_push_constants, 3, );
            CREATE_MMQ(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_Q4_SYM16K].f32acc, matmul_q4_sym16k_q8_1, mmq_wg_denoms, warptile_mmq_int_k, vk_mat_mat_push_constants, 3, );
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q2_SYM32K4].f32acc, matmul_id_subgroup_q2_sym32k4_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            CREATE_MM(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_QT_MS32K4].f32acc, matmul_id_subgroup_qt_ms32k4_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            CREATE_MM(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_SYM32K].f32acc, matmul_id_subgroup_q1_sym32k_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            CREATE_MM(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q4_SYM16K].f32acc, matmul_id_subgroup_q4_sym16k_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            CREATE_MM(GGML_TYPE_Q2_SYM32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q2_SYM32K4].f32acc, matmul_id_q2_sym32k4_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM(GGML_TYPE_QT_MS32K4, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_QT_MS32K4].f32acc, matmul_id_qt_ms32k4_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM(GGML_TYPE_Q1_SYM32K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_SYM32K].f32acc, matmul_id_q1_sym32k_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
            CREATE_MM(GGML_TYPE_Q4_SYM16K, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q4_SYM16K].f32acc, matmul_id_q4_sym16k_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#undef CREATE_MM
    ...
    // Make integer-dot MMQ prefill available for ternary weights on supported
    // devices. It amortizes sign-prefix popcounts across a tile; the dispatcher
    // can select it when the q8_1 pipeline exists. Scalar branches above have
    // already created these pipelines.
#if defined(GGML_VULKAN_INTEGER_DOT_GLSLC_SUPPORT)
    // NOTE: this must be re-entered on every ggml_vk_load_shaders pass (the
    // lazy compiler only compiles pipelines whose create call it sees again),
    // so the condition must be stable across passes -- never "is_empty".
    if (device->integer_dot_product && (device->coopmat2 || device->coopmat_support)) {
        // On coopmat devices the *_int_k warptiles were never initialized
        // (only the scalar branch sets them); build the standard ones here.
        if (l_warptile_mmq_int_k.empty()) {
            const uint32_t s_wm = device->subgroup_size == 8 ? 8 : 32;
            l_warptile_mmq_int_k = { 128,             128, 128, 32, subgroup_size_8 * 2, 64, 1, 4, 4, 1, subgroup_size_8 };
            m_warptile_mmq_int_k = { 128,              64,  64, 32, subgroup_size_8,     32, 1, 2, 2, 1, subgroup_size_8 };
            s_warptile_mmq_int_k = { subgroup_size_32, 32,  32, 32, s_wm,                32, 1, 2, 1, 1, subgroup_size_8 };
            l_warptile_mmqid_int_k = { 128,                     128, 128, 32, mul_mat_subgroup_size_16 * 2, 64, 1, 4, 4, 1, mul_mat_subgroup_size_16 };
            m_warptile_mmqid_int_k = { 128,                      64,  64, 32, mul_mat_subgroup_size_16,     32, 1, 2, 2, 1, mul_mat_subgroup_size_16 };
            s_warptile_mmqid_int_k = { mul_mat_subgroup_size_32, 32,  32, 32, s_wm,                         32, 1, 2, 1, 1, mul_mat_subgroup_size_16 };
        }
        // wg denoms must match these warptiles' BM/BN, not the coopmat ones
        const std::array<uint32_t, 3> l_tern_denoms = {128, 128, 1}, m_tern_denoms = {64, 64, 1}, s_tern_denoms = {32, 32, 1};
        if (device->mul_mat_l[GGML_TYPE_QT_MS32K4])
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_QT_MS32K4].f32acc->l, "matmul_qt_ms32k4_q8_1_l", matmul_qt_ms32k4_q8_1_fp32_len, matmul_qt_ms32k4_q8_1_fp32_data, "main", 3, sizeof(vk_mat_mat_push_constants), l_tern_denoms, l_warptile_mmq_int_k, 1);
        if (device->mul_mat_m[GGML_TYPE_QT_MS32K4])
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_QT_MS32K4].f32acc->m, "matmul_qt_ms32k4_q8_1_m", matmul_qt_ms32k4_q8_1_fp32_len, matmul_qt_ms32k4_q8_1_fp32_data, "main", 3, sizeof(vk_mat_mat_push_constants), m_tern_denoms, m_warptile_mmq_int_k, 1);
        if (device->mul_mat_s[GGML_TYPE_QT_MS32K4])
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_mat_q8_1[GGML_TYPE_QT_MS32K4].f32acc->s, "matmul_qt_ms32k4_q8_1_s", matmul_qt_ms32k4_q8_1_fp32_len, matmul_qt_ms32k4_q8_1_fp32_data, "main", 3, sizeof(vk_mat_mat_push_constants), s_tern_denoms, s_warptile_mmq_int_k, 1);
        if (device->mul_mat_id_l[GGML_TYPE_QT_MS32K4])
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_QT_MS32K4].f32acc->l, "matmul_id_qt_ms32k4_q8_1_l", matmul_id_qt_ms32k4_q8_1_fp32_len, matmul_id_qt_ms32k4_q8_1_fp32_data, "main", mul_mat_id_param_count, sizeof(vk_mat_mat_id_push_constants), l_tern_denoms, l_warptile_mmqid_int_k, 1);
        if (device->mul_mat_id_m[GGML_TYPE_QT_MS32K4])
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_QT_MS32K4].f32acc->m, "matmul_id_qt_ms32k4_q8_1_m", matmul_id_qt_ms32k4_q8_1_fp32_len, matmul_id_qt_ms32k4_q8_1_fp32_data, "main", mul_mat_id_param_count, sizeof(vk_mat_mat_id_push_constants), m_tern_denoms, m_warptile_mmqid_int_k, 1);
        if (device->mul_mat_id_s[GGML_TYPE_QT_MS32K4])
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_mat_id_q8_1[GGML_TYPE_QT_MS32K4].f32acc->s, "matmul_id_qt_ms32k4_q8_1_s", matmul_id_qt_ms32k4_q8_1_fp32_len, matmul_id_qt_ms32k4_q8_1_fp32_data, "main", mul_mat_id_param_count, sizeof(vk_mat_mat_id_push_constants), s_tern_denoms, s_warptile_mmqid_int_k, 1);
    }
#endif

#if defined(VK_KHR_cooperative_matrix) && defined(GGML_VULKAN_COOPMAT_GLSLC_SUPPORT)
    // KHR-coopmat pipelines for the ternary type on coopmat2 devices (route "khr").
    if (device->coopmat2 && device->coopmat_support && device->coopmat_m > 0) {
        const uint32_t tm = device->coopmat_m, tn = device->coopmat_n, tk = device->coopmat_k;
        const uint32_t s_wm = device->subgroup_size == 8 ? 8 : 32;
        const std::vector<uint32_t> l_wt   = { 128,             128, 128, 32, subgroup_size_8 * 2, 64, 2, tm, tn, tk, subgroup_size_8 };
        const std::vector<uint32_t> m_wt   = { 128,              64,  64, 32, subgroup_size_8,     32, 2, tm, tn, tk, subgroup_size_8 };
        const std::vector<uint32_t> s_wt   = { subgroup_size_32, 32,  32, 32, s_wm,                32, 2, tm, tn, tk, subgroup_size_8 };
        const std::vector<uint32_t> l_wtid = { 128,                      128, 128, 32, mul_mat_subgroup_size_8 * 2, 64, 2, tm, tn, tk, mul_mat_subgroup_size_8 };
        const std::vector<uint32_t> m_wtid = { 128,                       64,  64, 32, mul_mat_subgroup_size_8,     32, 2, tm, tn, tk, mul_mat_subgroup_size_8 };
        const std::vector<uint32_t> s_wtid = { mul_mat_subgroup_size_32,  32,  32, 32, s_wm,                        32, 2, tm, tn, tk, mul_mat_subgroup_size_8 };
        const std::array<uint32_t, 3> l_den = {128, 128, 1}, m_den = {64, 64, 1}, s_den = {32, 32, 1};
        const std::array<uint32_t, 3> l_denid = {128, 128, 1}, m_denid = {64, 64, 1}, s_denid = {32, 32, 1};
#define TKP(SLOT, NM, WT, DEN, ALG, PUSHT, NPARAM) \
        ggml_vk_create_pipeline(device, SLOT, #NM, NM ## _cm1_len, NM ## _cm1_data, "main", NPARAM, sizeof(PUSHT), DEN, WT, ALG, false, true)
        if (device->coopmat_acc_f32_support) {
            TKP(device->pipeline_tern_khr.f32acc->l,   matmul_qt_ms32k4_f32,          l_wt, l_den, 1, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f32acc->m,   matmul_qt_ms32k4_f32,          m_wt, m_den, 1, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f32acc->s,   matmul_qt_ms32k4_f32,          s_wt, s_den, 1, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f32acc->a_l, matmul_qt_ms32k4_f32_aligned,  l_wt, l_den, 128, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f32acc->a_m, matmul_qt_ms32k4_f32_aligned,  m_wt, m_den, 64, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f32acc->a_s, matmul_qt_ms32k4_f32_aligned,  s_wt, s_den, 32, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr_id.f32acc->l,   matmul_id_subgroup_qt_ms32k4_f32,         l_wtid, l_denid, 1, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f32acc->m,   matmul_id_subgroup_qt_ms32k4_f32,         m_wtid, m_denid, 1, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f32acc->s,   matmul_id_subgroup_qt_ms32k4_f32,         s_wtid, s_denid, 1, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f32acc->a_l, matmul_id_subgroup_qt_ms32k4_f32_aligned, l_wtid, l_denid, 128, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f32acc->a_m, matmul_id_subgroup_qt_ms32k4_f32_aligned, m_wtid, m_denid, 64, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f32acc->a_s, matmul_id_subgroup_qt_ms32k4_f32_aligned, s_wtid, s_denid, 32, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
        }
        if (device->coopmat_acc_f16_support) {
            TKP(device->pipeline_tern_khr.f16acc->l,   matmul_qt_ms32k4_f32_f16acc,          l_wt, l_den, 1, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f16acc->m,   matmul_qt_ms32k4_f32_f16acc,          m_wt, m_den, 1, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f16acc->s,   matmul_qt_ms32k4_f32_f16acc,          s_wt, s_den, 1, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f16acc->a_l, matmul_qt_ms32k4_f32_aligned_f16acc,  l_wt, l_den, 128, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f16acc->a_m, matmul_qt_ms32k4_f32_aligned_f16acc,  m_wt, m_den, 64, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr.f16acc->a_s, matmul_qt_ms32k4_f32_aligned_f16acc,  s_wt, s_den, 32, vk_mat_mat_push_constants, 3);
            TKP(device->pipeline_tern_khr_id.f16acc->l,   matmul_id_subgroup_qt_ms32k4_f32_f16acc,         l_wtid, l_denid, 1, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f16acc->m,   matmul_id_subgroup_qt_ms32k4_f32_f16acc,         m_wtid, m_denid, 1, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f16acc->s,   matmul_id_subgroup_qt_ms32k4_f32_f16acc,         s_wtid, s_denid, 1, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f16acc->a_l, matmul_id_subgroup_qt_ms32k4_f32_aligned_f16acc, l_wtid, l_denid, 128, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f16acc->a_m, matmul_id_subgroup_qt_ms32k4_f32_aligned_f16acc, m_wtid, m_denid, 64, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
            TKP(device->pipeline_tern_khr_id.f16acc->a_s, matmul_id_subgroup_qt_ms32k4_f32_aligned_f16acc, s_wtid, s_denid, 32, vk_mat_mat_id_push_constants, mul_mat_id_param_count);
        }
#undef TKP
    }
#endif
    ...
    for (uint32_t w = 0; w < DMMV_WG_SIZE_COUNT; ++w) {
        ...
        for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_Q2_SYM32K4][i], "mul_mat_vec_q2_sym32k4_f32_f32", arr_dmmv_q2_sym32k4_f32_f32_len[reduc16], arr_dmmv_q2_sym32k4_f32_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_QT_MS32K4][i], "mul_mat_vec_qt_ms32k4_f32_f32", arr_dmmv_qt_ms32k4_f32_f32_len[reduc16], arr_dmmv_qt_ms32k4_f32_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_Q1_SYM32K][i], "mul_mat_vec_q1_sym32k_f32_f32", arr_dmmv_q1_sym32k_f32_f32_len[reduc16], arr_dmmv_q1_sym32k_f32_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_Q4_SYM16K][i], "mul_mat_vec_q4_sym16k_f32_f32", arr_dmmv_q4_sym16k_f32_f32_len[reduc16], arr_dmmv_q4_sym16k_f32_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_Q2_SYM32K4][i], "mul_mat_vec_q2_sym32k4_f16_f32", arr_dmmv_q2_sym32k4_f16_f32_len[reduc16], arr_dmmv_q2_sym32k4_f16_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_QT_MS32K4][i], "mul_mat_vec_qt_ms32k4_f16_f32", arr_dmmv_qt_ms32k4_f16_f32_len[reduc16], arr_dmmv_qt_ms32k4_f16_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_Q1_SYM32K][i], "mul_mat_vec_q1_sym32k_f16_f32", arr_dmmv_q1_sym32k_f16_f32_len[reduc16], arr_dmmv_q1_sym32k_f16_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_Q4_SYM16K][i], "mul_mat_vec_q4_sym16k_f16_f32", arr_dmmv_q4_sym16k_f16_f32_len[reduc16], arr_dmmv_q4_sym16k_f16_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ...
            if (device->integer_dot_product) {
                ...
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[w][GGML_TYPE_Q2_SYM32K4][i], "mul_mat_vec_q2_sym32k4_q8_1_f32", arr_dmmv_q2_sym32k4_q8_1_f32_len[reduc], arr_dmmv_q2_sym32k4_q8_1_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {2*rm_kq_int, 1, 1}, {wg_size_subgroup_int, 2*rm_kq_int, i+1}, 1, true, use_subgroups, subgroup_size_int);
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[w][GGML_TYPE_QT_MS32K4][i], "mul_mat_vec_qt_ms32k4_q8_1_f32", arr_dmmv_qt_ms32k4_q8_1_f32_len[reduc], arr_dmmv_qt_ms32k4_q8_1_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {2*rm_kq_int, 1, 1}, {wg_size_subgroup_int, 2*rm_kq_int, i+1}, 1, true, use_subgroups, subgroup_size_int);
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[w][GGML_TYPE_Q1_SYM32K][i], "mul_mat_vec_q1_sym32k_q8_1_f32", arr_dmmv_q1_sym32k_q8_1_f32_len[reduc], arr_dmmv_q1_sym32k_q8_1_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {2*rm_kq_int, 1, 1}, {wg_size_subgroup_int, 2*rm_kq_int, i+1}, 1, true, use_subgroups, subgroup_size_int);
                ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_q8_1_f32[w][GGML_TYPE_Q4_SYM16K][i], "mul_mat_vec_q4_sym16k_q8_1_f32", arr_dmmv_q4_sym16k_q8_1_f32_len[reduc], arr_dmmv_q4_sym16k_q8_1_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {2*rm_kq_int, 1, 1}, {wg_size_subgroup_int, 2*rm_kq_int, i+1}, 1, true, use_subgroups, subgroup_size_int);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_Q2_SYM32K4], "mul_mat_vec_id_q2_sym32k4_f32",       arr_dmmv_id_q2_sym32k4_f32_f32_len[reduc16],    arr_dmmv_id_q2_sym32k4_f32_f32_data[reduc16],    "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_QT_MS32K4], "mul_mat_vec_id_qt_ms32k4_f32",       arr_dmmv_id_qt_ms32k4_f32_f32_len[reduc16],    arr_dmmv_id_qt_ms32k4_f32_f32_data[reduc16],    "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_Q1_SYM32K], "mul_mat_vec_id_q1_sym32k_f32",       arr_dmmv_id_q1_sym32k_f32_f32_len[reduc16],    arr_dmmv_id_q1_sym32k_f32_f32_data[reduc16],    "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_Q4_SYM16K], "mul_mat_vec_id_q4_sym16k_f32",       arr_dmmv_id_q4_sym16k_f32_f32_len[reduc16],    arr_dmmv_id_q4_sym16k_f32_f32_data[reduc16],    "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
        ...
        if (device->integer_dot_product) {
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_Q2_SYM32K4], "mul_mat_vec_id_q2_sym32k4_q8_1_f32", arr_dmmv_id_q2_sym32k4_q8_1_f32_len[reduc], arr_dmmv_id_q2_sym32k4_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {2*rm_kq_int, 1, 1}, {wg_size_subgroup_int, 2*rm_kq_int}, 1, true, use_subgroups, subgroup_size_int);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_QT_MS32K4], "mul_mat_vec_id_qt_ms32k4_q8_1_f32", arr_dmmv_id_qt_ms32k4_q8_1_f32_len[reduc], arr_dmmv_id_qt_ms32k4_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {2*rm_kq_int, 1, 1}, {wg_size_subgroup_int, 2*rm_kq_int}, 1, true, use_subgroups, subgroup_size_int);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_Q1_SYM32K], "mul_mat_vec_id_q1_sym32k_q8_1_f32", arr_dmmv_id_q1_sym32k_q8_1_f32_len[reduc], arr_dmmv_id_q1_sym32k_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {2*rm_kq_int, 1, 1}, {wg_size_subgroup_int, 2*rm_kq_int}, 1, true, use_subgroups, subgroup_size_int);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_q8_1_f32[w][GGML_TYPE_Q4_SYM16K], "mul_mat_vec_id_q4_sym16k_q8_1_f32", arr_dmmv_id_q4_sym16k_q8_1_f32_len[reduc], arr_dmmv_id_q4_sym16k_q8_1_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {2*rm_kq_int, 1, 1}, {wg_size_subgroup_int, 2*rm_kq_int}, 1, true, use_subgroups, subgroup_size_int);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_Q2_SYM32K4], "dequant_q2_sym32k4", dequant_q2_sym32k4_len, dequant_q2_sym32k4_data, "main", 2, 5 * sizeof(uint32_t), {256 * 32, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_QT_MS32K4], "dequant_qt_ms32k4", dequant_qt_ms32k4_len, dequant_qt_ms32k4_data, "main", 2, 5 * sizeof(uint32_t), {256 * 32, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_Q1_SYM32K], "dequant_q1_sym32k", dequant_q1_sym32k_len, dequant_q1_sym32k_data, "main", 2, 5 * sizeof(uint32_t), {256 * 32, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_Q4_SYM16K], "dequant_q4_sym16k", dequant_q4_sym16k_len, dequant_q4_sym16k_data, "main", 2, 5 * sizeof(uint32_t), {128 * 32, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_get_rows[GGML_TYPE_Q2_SYM32K4], "get_rows_q2_sym32k4", get_rows_q2_sym32k4_len, get_rows_q2_sym32k4_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_get_rows[GGML_TYPE_QT_MS32K4], "get_rows_qt_ms32k4", get_rows_qt_ms32k4_len, get_rows_qt_ms32k4_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_get_rows[GGML_TYPE_Q1_SYM32K], "get_rows_q1_sym32k", get_rows_q1_sym32k_len, get_rows_q1_sym32k_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_get_rows[GGML_TYPE_Q4_SYM16K], "get_rows_q4_sym16k", get_rows_q4_sym16k_len, get_rows_q4_sym16k_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_get_rows_f32[GGML_TYPE_Q2_SYM32K4], "get_rows_q2_sym32k4_f32", get_rows_q2_sym32k4_f32_len, get_rows_q2_sym32k4_f32_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_get_rows_f32[GGML_TYPE_QT_MS32K4], "get_rows_qt_ms32k4_f32", get_rows_qt_ms32k4_f32_len, get_rows_qt_ms32k4_f32_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_get_rows_f32[GGML_TYPE_Q1_SYM32K], "get_rows_q1_sym32k_f32", get_rows_q1_sym32k_f32_len, get_rows_q1_sym32k_f32_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_get_rows_f32[GGML_TYPE_Q4_SYM16K], "get_rows_q4_sym16k_f32", get_rows_q4_sym16k_f32_len, get_rows_q4_sym16k_f32_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
...
static void ggml_vk_instance_init() {
    ...
    if (api_version < VK_API_VERSION_1_2) {
        // Not exceptional: report a backend with no devices instead of
        // throwing, so environments without working C++ unwinding (and
        // machines without a usable Vulkan) degrade to other backends.
        std::cerr << "ggml_vulkan: Error: Vulkan 1.2 required, found " << VK_API_VERSION_MAJOR(api_version) << "." << VK_API_VERSION_MINOR(api_version) << "; Vulkan backend has no devices" << std::endl;
    ...
    // Create the instance through the C API: on machines without a Vulkan
    // driver this fails with VK_ERROR_INCOMPATIBLE_DRIVER, which is an
    // expected condition, not an exception -- report zero devices and let
    // the registry fall back to other backends.
    VkInstance created_instance = VK_NULL_HANDLE;
    const VkInstanceCreateInfo & instance_create_info_c = instance_create_info;
    VkResult instance_result = vkCreateInstance(&instance_create_info_c, nullptr, &created_instance);
    if (instance_result != VK_SUCCESS) {
        std::cerr << "ggml_vulkan: no usable Vulkan implementation (vkCreateInstance failed with " << instance_result << "); Vulkan backend has no devices" << std::endl;
        vk_instance_initialized = true;
        return;
    }
    vk_instance.instance = vk::Instance(created_instance);
    vk_instance_initialized = true;
...
// Prefill route for the ternary type on coopmat2 devices. The coopmat2
// per-element decode computes the sign-prefix popcount per weight;
// the KHR-coopmat and integer (MMQ) paths amortize it per tile.
// GGML_VK_TERN_PREFILL=cm2|khr|mmq selects the prefill route.
static int ggml_vk_tern_prefill_route() {
    static int route = [] {
        const char * e = getenv("GGML_VK_TERN_PREFILL");
        if (e != nullptr) {
            if (strcmp(e, "cm2") == 0) return 0;
            if (strcmp(e, "khr") == 0) return 1;
            if (strcmp(e, "mmq") == 0) return 2;
        }
        return 1;
    }();
    return route;
...
static vk_matmul_pipeline ggml_vk_get_mul_mat_mat_pipeline(ggml_backend_vk_context * ctx, ggml_type src0_type, ggml_type src1_type, ggml_prec prec) {
    ...
    if (src1_type == GGML_TYPE_Q8_1) {
        if (src0_type == GGML_TYPE_QT_MS32K4 && ctx->device->coopmat2 && ggml_vk_tern_prefill_route() != 2) {
            return nullptr;
        }
    ...
    if (src0_type == GGML_TYPE_QT_MS32K4 && ctx->device->coopmat2 && src1_type == GGML_TYPE_F32 &&
        ggml_vk_tern_prefill_route() == 1 && !ctx->device->pipeline_tern_khr.f32acc->is_empty()) {
        return (ctx->device->fp16 && ctx->device->coopmat_acc_f16_support && prec == GGML_PREC_DEFAULT && !ctx->device->pipeline_tern_khr.f16acc->is_empty())
            ? ctx->device->pipeline_tern_khr.f16acc : ctx->device->pipeline_tern_khr.f32acc;
    }
...
static vk_matmul_pipeline ggml_vk_get_mul_mat_mat_id_pipeline(ggml_backend_vk_context * ctx, ggml_type src0_type, ggml_type src1_type, ggml_prec prec) {
    ...
    if (src0_type == GGML_TYPE_QT_MS32K4 && ctx->device->coopmat2 && src1_type == GGML_TYPE_F32 &&
        ggml_vk_tern_prefill_route() == 1 && !ctx->device->pipeline_tern_khr_id.f32acc->is_empty()) {
        return (ctx->device->fp16 && ctx->device->coopmat_acc_f16_support && prec == GGML_PREC_DEFAULT && !ctx->device->pipeline_tern_khr_id.f16acc->is_empty())
            ? ctx->device->pipeline_tern_khr_id.f16acc : ctx->device->pipeline_tern_khr_id.f32acc;
    }
...
static vk_pipeline ggml_vk_guess_matmul_pipeline(ggml_backend_vk_context * ctx, vk_matmul_pipeline& mmp, uint32_t m, uint32_t n, bool aligned, ggml_type src0_type, ggml_type src1_type) {
    ...
    // The q8_1 (MMQ) pipelines have no aligned/coopmat2 variants, so the
    // coopmat2 tile heuristic below must not dereference them.
    if (ctx->device->coopmat2 && mmp->a_l != nullptr) {
...
static vk_pipeline ggml_vk_guess_matmul_id_pipeline(ggml_backend_vk_context * ctx, vk_matmul_pipeline& mmp, uint32_t m, uint32_t n, bool aligned, ggml_type src0_type) {
    ...
    // see ggml_vk_guess_matmul_pipeline: q8_1 pipelines have no aligned variants
    if (ctx->device->coopmat2 && mmp->a_l != nullptr) {
        // Use large shader when the N dimension is greater than the medium shader's tile size
        uint32_t crossover_large = mmp->m->wg_denoms[1];
...
static void ggml_vk_mul_mat_q_f16(ggml_backend_vk_context * ctx, vk_context& subctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst, bool disable_split_k) {
    ...
    const bool y_non_contig_base = (src0->type == GGML_TYPE_BF16 && src1->type != GGML_TYPE_BF16) ||
                              !ggml_vk_dim01_contiguous(src1);
    bool y_non_contig = (ctx->device->coopmat2 && src1->type == GGML_TYPE_F32 &&
                         !(src0->type == GGML_TYPE_QT_MS32K4 && ggml_vk_tern_prefill_route() != 0)) || y_non_contig_base;

    // If src0 is BF16, try to use a BF16 x BF16 multiply
    ggml_type f16_type = src0->type == GGML_TYPE_BF16 ? GGML_TYPE_BF16 : GGML_TYPE_F16;

    // The coopmat2 fp16-conversion preference must not gate the q8_1 (MMQ)
    // route: a type whose q8_1 pipeline exists on a coopmat2 device (the
    // ternary type) decodes far faster there than through coopmat2.
    bool quantize_y = ctx->device->integer_dot_product && src1->type == GGML_TYPE_F32 && ggml_is_contiguous(src1) && !y_non_contig_base && (ne11 * ne10) % 4 == 0;
    ...
    if (mmp == nullptr) {
        ...
        y_non_contig = false; // the q8_1 path consumes src1 directly
    }
...
static bool ggml_vk_should_use_mmvq(const vk_device& device, uint32_t m, uint32_t n, uint32_t k, ggml_type src0_type) {
    ...
    case VK_VENDOR_ID_NVIDIA:
        if (src0_type == GGML_TYPE_Q2_K || src0_type == GGML_TYPE_IQ1_S || src0_type == GGML_TYPE_IQ1_M ||
            src0_type == GGML_TYPE_Q2_SYM32K4 || src0_type == GGML_TYPE_Q1_SYM32K || src0_type == GGML_TYPE_Q4_SYM16K || src0_type == GGML_TYPE_QT_MS32K4) {
            return true;
        }
