...
bool ggml_backend_metal_buffer_is_shared(ggml_backend_buffer_t buffer) {
    return buffer && buffer->iface.set_tensor == ggml_backend_metal_buffer_shared_set_tensor;
}
...
static void * ggml_backend_metal_get_proc_address(ggml_backend_reg_t reg, const char * name) {
    if (strcmp(name, "ggml_backend_metal_buffer_is_shared") == 0) {
        return (void *)ggml_backend_metal_buffer_is_shared;
    }
