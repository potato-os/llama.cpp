...
struct block_q4_sym16x4 {
    uint8_t d[8];   // UE4M3 scales: rows 0..3 group0, then rows 0..3 group1
    uint8_t qs[64]; // 4-byte chunks interleaved across 4 rows: [r0c0 r1c0 r2c0 r3c0 r0c1 ...]
};
static_assert(sizeof(block_q4_sym16x4) == 8 + QK4_SYM16 * 2, "wrong q4_sym16x4 block size/padding");
