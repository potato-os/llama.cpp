...
static __global__ void k_get_rows_back_float(
        ...
        const int64_t ncols, const int64_t nrows_dst, const int64_t nrows_grad) {
    ...
    for (int64_t dst_row = blockIdx.y*blockDim.y + threadIdx.y; dst_row < nrows_dst; dst_row += gridDim.y*blockDim.y) {
        float sum = 0.0f;
...
static void ggml_cuda_get_rows_switch_src0_type(
    ...
    switch (src0_type) {
        ...
        case GGML_TYPE_Q4_SYM16:
            get_rows_cuda_q<QK4_SYM16, 2, dequantize_q4_sym16>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_Q2_SYM32K4:
            get_rows_cuda_q<QK2_SYM32K, 2, dequantize_q2_sym32k4>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_Q1_SYM32K:
            get_rows_cuda_q<QK1_SYM32K, 2, dequantize_q1_sym32k>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_Q4_SYM16K:
            get_rows_cuda_q<QK4_SYM16K, 2, dequantize_q4_sym16k>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_Q5_0:
...
void ggml_cuda_op_get_rows_back(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    ...
    const dim3 block_nums(block_num_x, MIN(ne1, UINT16_MAX), 1);

    k_get_rows_back_float<<<block_nums, block_dims, 0, stream>>>(src0_d, src1_d, dst_d, ne00, ne1, ne10);
}
