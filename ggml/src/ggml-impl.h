...
// Precomputed ggml_ue4m3_to_fp32 for hot loops (all values exact in fp32;
// indices 0x00 and 0x7F decode to 0, bit 7 is ignored like in the function).
static const float ggml_table_ue4m3_f32[256] = {
